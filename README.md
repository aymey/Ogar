...
Once the game server is running, you can connect (locally) by typing `agar.io/?ip=127.0.0.1:443` into your browser's address bar. or connect via websockets in console:
```
core.disableIntegrityChecks(true)
core.connect("ws://127.0.0.1:443")
```
